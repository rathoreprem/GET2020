...
function namevalidation() {
    ...
    var y = 1;
    var x;
    x = document.getElementById("employeeName").value;
    // document.write("hi34");
...
function emailvalidation() {
    var emails = document.getElementById('employeeEmails').value;
...
function passvalidation() {
    var passwords = document.getElementById("employeePassword").value;
    var special = 0, numbers = 0, lower = 0, upper = 0;
...
function confirmpassvalidation() {
    ...
    var special = 0, number = 0, lower = 0, upper = 0;
...
function confirmpassword(item, event) {
    var x = event.keyCode;
    if (x == 13) {
...
function number(item, event) {
    var x = event.keyCode;
    if (x == 13) {
        numbervalidation();
    }
}
function vehicleCompanyName(item, event) {
    var x = event.keyCode;
    if (x == 13) {
...
function vehicleModel(item, event) {
    var x = event.keyCode;
    if (x == 13) {
...
function Type(item, event) {
    ...
    if (x == 13) {
        ...
        document.getElementById("empid").value = (Math.floor(Math.random() * 1000 + 1)).toString();
    }
}
function EmployeeId(item, event) {
    var x = event.keyCode;
    if (x == 13) {
...
function vehicleIdentification(item, event) {
    console.log("hi");
    var x = event.keyCode;
    if (x == 13) {
...
function rupaye(x) {
    if (x.value == "INR") {
        document.getElementById("stop").value = finalPlan.toString();
        ...
        document.getElementById("stop").value = (finalPlan / 71.46).toString();
        document.getElementById("stop").setAttribute("style", "display:block");
        document.getElementById("pay").setAttribute("style", "display:block");
    }
    else if (x.value == "YEN") {
        document.getElementById("stop").value = (finalPlan / 0.66).toString();
        document.getElementById("stop").setAttribute("style", "display:block");
        document.getElementById("pay").setAttribute("style", "display:block");
    }
}
